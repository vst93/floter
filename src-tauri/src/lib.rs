...
use commands::extensions::{
    ...
    extensions_uninstall, extensions_update, extensions_check_updates,
};
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            system_power,
            extensions_list,
            extensions_refresh_official_status,
            extensions_export,
            extensions_import,
            extensions_export_source_bundle,
            extensions_infer_source,
