...
export const CLIPBOARD_ICON_NODES: Record<ClipboardIconName, readonly IconNode[]> = {
  ...
  // R27 · lucide `settings` — the plugin-settings toggle. The same gear the
  // launcher's own settings button draws, so the two controls read as the same
  // affordance on the two surfaces.
  settings: [
