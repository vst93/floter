...
export function LauncherResults({
  ...
  // R64 · the ⌘-held bare-terminal row is appended to the list's end by the App
  // (`bareTerminalPlacement`), below the recents block and its 「最近启动」
  // heading, as an ordinary system row. The heading therefore always sits at the
  // top of the empty page, exactly as it did before R61.
